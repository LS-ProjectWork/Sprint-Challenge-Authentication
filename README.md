...
Sessions help servers store information about a user (i.e login information, roles, etc).

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt helps us hash passwords.

1. What does bcrypt do to slow down attackers?

Bcrypt goes through several rounds of hashing
